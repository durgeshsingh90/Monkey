...
def create_reversal_0400_message(auth_request, auth_response):
    reversal_message = {}

    # Copying mandatory data elements from the auth request
    reversal_message['mti'] = 400
...
#     reversal_message = create_reversal_0400_message(auth_request, auth_response)
