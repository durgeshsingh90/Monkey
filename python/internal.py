...
file_path = r"C:\Users\f94gdos\Downloads\dr_internal_bcmc_reject_count.txt"
...
expected_index = 'INTERNAL_RESPONSE_CODE_RSP'
...
if expected_index in df.columns and expected_columns in df.columns and expected_values in df.columns:
    ...
    fig = px.bar(melted_df, x=expected_index, y='RESPONSE_CODE_COUNT', color='TRANSACTION_DATE',
                 ...
                 labels={'RESPONSE_CODE_COUNT': 'Response Code Count', 'INTERNAL_RESPONSE_CODE_RSP': 'Response Code'},
                 barmode='group')
